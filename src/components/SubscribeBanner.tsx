...
const SubscribeBanner = ({ onOpenParentalGate, questionsRemaining, isPremium }: SubscribeBannerProps) => {
  ...
  return (
    <motion.button
      ...
      className="w-full flex items-center justify-between px-4 py-2.5 bg-gradient-to-r from-amber-50/90 to-yellow-50/90 border-b border-amber-200/40"
    ...
    >
      ...
      <div className="flex items-center gap-1 bg-amber-400 px-2.5 py-1 rounded-full shadow-sm">
