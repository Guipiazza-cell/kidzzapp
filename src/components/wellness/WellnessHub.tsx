    ...
    <div className="kalm-root" style={{ position: "relative", overflow: "hidden", fontFamily: "'Nunito',system-ui,sans-serif", background: "linear-gradient(180deg,#EEF4E9 0%,#E4EEDD 42%,#D8E6CF 75%,#CBDCC0 100%)" }}>
      ...
      <div style={{ position: "relative" }}>
        ...
        <div style={{ position: "relative" }} data-screen-label="Hero KALM">
          <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: 414, backgroundImage: "url('/exemplos/assets/camaleao-oficial/arms-soft.png')", backgroundSize: "cover", backgroundPosition: "center", filter: "blur(46px) saturate(1.45)", opacity: 0.5, transform: "scale(1.22)", pointerEvents: "none" }} />
          <div ref={heroWrapRef} style={{ position: "relative", width: "100%", height: 414, willChange: "transform, opacity", WebkitMaskImage: "radial-gradient(74% 78% at 50% 42%, #000 38%, rgba(0,0,0,.92) 52%, rgba(0,0,0,.55) 68%, rgba(0,0,0,.18) 82%, transparent 96%)", maskImage: "radial-gradient(74% 78% at 50% 42%, #000 38%, rgba(0,0,0,.92) 52%, rgba(0,0,0,.55) 68%, rgba(0,0,0,.18) 82%, transparent 96%)", animation: "kalm-heroIn .7s cubic-bezier(.22,1,.36,1) both" }}>
            <img src="/exemplos/assets/camaleao-oficial/arms-soft.png" alt="Gui, o camaleão, na floresta" style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", objectFit: "contain", objectPosition: "center 28%", animation: "kalm-floaty 7s ease-in-out infinite", filter: "drop-shadow(0 18px 24px rgba(40,60,30,.28))" }} />
