    ...
    <div className="min-h-screen flex flex-col overflow-hidden relative">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6">
        ...
        <motion.button
          ...
          className="mt-6 flex items-center gap-2 text-white/60 hover:text-white/90 transition-colors opacity-100 rounded-2xl shadow-none text-3xl"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 1.5 }}>
          
          <Shield size={14} className="w-[100px] h-[100px]" />
          Controle Parental
        </motion.button>
      </div>
