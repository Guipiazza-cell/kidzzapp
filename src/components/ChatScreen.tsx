...
const ChatScreen = ({
  ...
  // Memória contextual premium: busca última pergunta de dia anterior (falha silenciosa)
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.warn("[Kidzz] chat memória falhou (fallback silencioso):", e?.message ?? e);
      }
    })();
