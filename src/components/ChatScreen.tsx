...
const ChatScreen = ({ onOpenStoryFactory }: { onOpenStoryFactory?: () => void }) => {
  ...
  const handleCheckout = useCallback(async () => {
    ...
    try {
      ...
      if (data.url) window.open(data.url, "_blank");else
      ...
      <div className="flex-1 flex flex-col relative z-10 min-h-0">
        ...
        <motion.div
          ...
          transition={{ delay: 0.2 }}>
            ...
            <h2 className="text-xl font-extrabold text-white text-center mt-2 drop-shadow-lg">Pergunta pra mim qualquer coisa 

          </h2>
            <p className="text-white/70 text-center text-sm max-w-[260px] mt-1">Eu adoro responder! Pode falar ou digitar 
